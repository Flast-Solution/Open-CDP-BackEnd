...
(24,NULL,'2','other',2,NULL,NULL,'Bal Fing',NULL,NULL,NULL,'Tuyên Quang',NULL,NULL,NULL,'',NULL,'0984554774',NULL,NULL,NULL,NULL,'2025-07-24 15:27:31','2025-07-24 15:27:31',NULL,0);
...
CREATE TABLE `shipping_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `sso_id` varchar(100) COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `status` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `transport_id_UNIQUE` (`transport_name`),
...
(274,5,'Kho Nam Từ Liêm','Administrator',776,10208,'[{\"text\":\"Dạng kết cấu\",\"values\":[{\"id\":10385,\"text\":\"Hai tầng\"},{\"id\":10383,\"text\":\"Âm dương nắp lật\"}]},{\"text\":\"Bồi vỏ\",\"values\":[{\"id\":10389,\"text\":\"Giấy Mỹ thuật\"},{\"id\":10388,\"text\":\"Giấy Crat\"}]}]',0,11,11,'2025-07-14 09:04:44',10008,'Hộp 1.3mm'),
(275,1,'Kho Trung Hòa','Administrator',776,10209,'[{\"text\":\"Dạng kết cấu\",\"values\":[{\"id\":10395,\"text\":\"Hai cánh mở giữa\"}]},{\"text\":\"Bồi vỏ\",\"values\":[{\"id\":10399,\"text\":\"Giấy Op/Ford\"}]}]',0,20,200,'2025-07-15 02:55:56',10009,'Hộp 1.5mm'),
(276,4,'Kho Trung Hòa 3','Administrator',774,10198,'[{\"text\":\"PHong cách\",\"values\":[{\"id\":10341,\"text\":\"Tối giản B+\"}]}]',0,100,100,'2025-07-16 08:51:20',10009,'Thuộc tính gia công và đóng gói'),
(278,4,'Kho Trung Hòa 3','Administrator',776,10208,'[{\"text\":\"Dạng kết cấu\",\"values\":[{\"id\":10385,\"text\":\"Hai tầng\"},{\"id\":10383,\"text\":\"Âm dương nắp lật\"}]},{\"text\":\"Bồi vỏ\",\"values\":[{\"id\":10389,\"text\":\"Giấy Mỹ thuật\"},{\"id\":10388,\"text\":\"Giấy Crat\"}]}]',0,4,4,'2025-08-01 07:40:06',10008,'Hộp 1.3mm');
...
-- Dump completed on 2025-08-01 15:54:37
